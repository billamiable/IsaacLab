...
parser.add_argument("--right-wrist-pos", type=float, nargs=3, default=(0.10, 0.0, 0.06))
parser.add_argument("--right-wrist-rot-world", type=float, nargs=4, default=(0.97272445, -0.00059490, 0.23196287, 0.00014329))
parser.add_argument("--left-wrist-pos", type=float, nargs=3, default=(0.10, 0.0, 0.06))
parser.add_argument("--left-wrist-rot-world", type=float, nargs=4, default=(0.97272445, 0.00059452, 0.23196287, -0.00014170))
parser.add_argument("--ego-pos", type=float, nargs=3, default=(0.0576, 0.0, 0.4299))
